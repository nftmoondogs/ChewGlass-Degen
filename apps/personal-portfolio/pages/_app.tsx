  ...
  return (
    <Provider {...{ store }}>
      <PersistGate loading={<Preloader />} {...{ persistor }}>
        ...
        >
          <Head>
            <title>$ChewGlass Token</title>
            <meta name="title" content="$ChewGlass Token" />
            <meta
              name="description"
            ...
            <meta property="og:title" content="$ChewGlass Token" />
            <meta
            ...
            />
            <meta property="twitter:title" content="$ChewGlass Token" />
            <meta
